...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-success">
        <div class="container">
            <a class="navbar-brand " href="#"><img src="Rail LOGO-1.png" alt=""></a>
    ...
    <form>
        ...
        <datalist id="sta">
            ...
            <option value="Rajshahi"></option>
                ...
                <label for="seat" style="color:pink">Choose a class:</label><br>
    ...
    <div class="search"> <a href="HaveAnyAcc.html" class="seatlink" >SEARCH TRAIN</a></div> 
